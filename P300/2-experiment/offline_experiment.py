...
class P300Window(object):
    ...
    def create_flash_sequence(self):
        ...
        sequence_length = 700  # ms  #no repeating elements within the minimum of 700ms
        distance_between_similar_elements = int((sequence_length / self.break_duration) + 1)  # int(700 / 250 ) = 2 + 1 = 3  #make sure no repeating elements within 3 consecutive
