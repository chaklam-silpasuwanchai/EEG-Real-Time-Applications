...
def GenerateCharacters():
	...
	for char in characters:
		...
		for background_color in background_colors:
			...
			draw.text((x, y), char, (245-background_color) + randint(0, 10) , font=font)
	
			# Final file name    	
			file_name = out_dir + char + '_black.png'
...
background_colors =  white #white_colors # + black_colors + gray_colors
